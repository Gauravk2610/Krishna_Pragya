      ...
      <div className="max-w-6xl w-full px-4 xl:mx-auto">
        ...
        <div className="mt-6 space-y-4">
          <h1 className="text-xl sm:text-3xl text-center font-bold">
            {isEng
              ? `SUBSCRIPTION FOR INDIAN KRISHN'S LOVERS`
              : `भारत में रहने वाले कृष्ण प्रेमियों के लिए सब्सक्राइब`}
          </h1>
          <div className="border-2 border-black border-b-0">
            {SubscriptionModel.map((item) => (
              <div className="flex gap-x-2 justify-between items-center py-2 px-6 border-b-2 border-black">
                <div className="max-w-lg w-full">{item.name}</div>
        ...
        <div className="mt-6 space-y-4">
          <h1 className="text-xl sm:text-3xl text-center font-bold">
            {isEng
              ? `SUBSCRIPTION FOR INTERNATIONAL KRISHN'S LOVERS`
              : `भारत के अलावा अन्य देशों में रहने वाले कृष्ण प्रेमियों के लिए सब्सक्राइब`}
          </h1>
        ...
        <div className="flex justify-center mt-16">
          <button className="linear-bg px-4 py-2 text-lg font-bold rounded-lg text-white">
            {isEng ? "PAY NOW" : "अभी भुगतान करें"}
          </button>
        </div>
      </div>
    </div>
