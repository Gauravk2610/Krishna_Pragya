...
const Header = () => {
  ...
  const SmHamBurgerMenu = [
    ...
    {
      name: isEng ? "Krishn Pragya" : 'कृष्ण प्रज्ञा',
      link: "/krishn-pragya",
    },
    {
      name: isEng ? "Conversations" : 'बात-चित',
  ...
  return (
    <div className="header h-28 flex px-4 lg:px-8 py-4 justify-between items-center">
      {/* Logo */}
      <Link to="/">
        <img
      ...
      {/* Navigation Menu */}
      <div className="flex lg:mr-4 items-center">
        {/* Menu */}
        <div className="flex items-center space-x-2 lg:space-x-8">
          {menu.map((item, index) =>
            item.link.includes("#") ? (
              <a className="menu-item hidden xl:inline-flex" key={index} href={`${item.link}`}>
                {item.name}
              </a>
            ) : (
              <Link
                ...
                className="menu-item relative menu hidden xl:inline-flex"
              >
                {item?.name}
          ...
          />
          {/* Language selection */}
          <div className="flex items-center ,d:space-x-1">
            <span
              onClick={() => handLangugaeChange("हिन्दी")}
              className={`menu-item text-base lg:text-lg ${
          ...
          <div className="px-8 max-w-5xl w-full lg:mx-auto">
            <div className="flex flex-col w-full  ">
              ...
              <div className="mx-auto ">
                <div className="ml-8 hidden xl:inline-block space-y-2">
                ...
                <div className="ml-8  xl:hidden space-y-2">
                  {SmHamBurgerMenu.map((item, index) =>
                    !item?.subMenu ? (
                      <div>
                        <Link
                          key={index}
